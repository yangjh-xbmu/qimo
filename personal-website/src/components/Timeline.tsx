      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          {experiences.map((exp, index) => {
            ...
            return (
              <div key={exp.id} className={`relative flex items-center justify-between mb-12 ${isEven ? 'md:flex-row-reverse' : 'md:flex-row'}`}>
                {/* Content */}
                ...
                {/* Center Dot */}
                <div className="absolute left-4 md:left-1/2 w-4 h-4 bg-secondary rounded-full border-4 border-white shadow transform -translate-x-1/2"></div>
